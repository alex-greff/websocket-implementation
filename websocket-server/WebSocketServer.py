...
class WebSocketConnection:
    """Represents a websocket connection that we can send and receive data on
    Depends on an underlying TCP socket which must be already connected to a client"""
...
class WSFrame:
    def __init__(self, bytes):
        ...
        self.opcode = '0000'
        # 1 bit, true if payload is masked (server does not need to mask data)
        self.mask = '0'
