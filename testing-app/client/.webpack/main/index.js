...
var createWindow = function () {
    var ELECTRON_ENV = process.env.ELECTRON_ENV || "production";
    if (ELECTRON_ENV == "production") {
    ...
    // Development environment
        ...
        var ELECTRON_NUM_WINDOWS = parseInt(process.env.ELECTRON_NUM_WINDOWS || "1") || 1;
        // Create as many window instances as specified
        for (var i = 0; i < ELECTRON_NUM_WINDOWS; i++) {
            // Create the browser window.
            var currWindow = new electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow({
                height: 800,
                width: 1000,
                webPreferences: {
                    nodeIntegration: true,
            ...
            // and load the index.html of the app.
            currWindow.loadURL('http://localhost:3000/main_window');
